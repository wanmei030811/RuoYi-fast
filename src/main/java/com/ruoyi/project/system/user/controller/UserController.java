...
public class UserController extends BaseController {
  ...
  public String add(ModelMap modelMap) {
    modelMap.put("roles", roleService.selectRoleAll().stream().filter(r -> !r.isAdmin()).collect(Collectors.toList()));
  ...
  public String edit(@PathVariable("userId") Long userId, ModelMap modelMap) {
    ...
    modelMap.put("roles", User.isAdmin(userId) ? roles : roles.stream().filter(r -> !r.isAdmin()).collect(Collectors.toList()));
  ...
  public String view(@PathVariable("userId") Long userId, ModelMap modelMap) {
    userService.checkUserDataScope(userId);
    modelMap.put("user", userService.selectUserById(userId));
    modelMap.put("roleGroup", userService.selectUserRoleGroup(userId));
    modelMap.put("postGroup", userService.selectUserPostGroup(userId));
    return prefix + "/view";
  }
